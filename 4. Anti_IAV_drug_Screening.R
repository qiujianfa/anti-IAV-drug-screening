...
rm(list = ls())
setwd("E:/Research_Project/Drug_combination/connectivity_map/level5/20240704/1.ranking/IAV")


###Read functional score table
setwd("E:/Research_Project/Drug_combination/genome_wide_screening/Flu/20240704/1.IAV_ranking_aggregation")
...
###GSE92742 dataset
setwd("E:/Research_Project/Drug_combination/connectivity_map/level5")
